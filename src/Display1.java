...
/**
 * die Klasse Display1 liefert eine Grafikanzeige mit Koordinatensystem und kann
...
public class Display1 extends Frame {
	...
	/**
	 * Durchmesser f�r Punkte und Achsenmarkierungen
	 */
	private int pixnum = 4;
	 ...
	 */
	private Vector<Punkt> punkte;

	/**
	 * darzustellende Rechtecke
	 */

	private Vector<Rechteck> rechtecke;
